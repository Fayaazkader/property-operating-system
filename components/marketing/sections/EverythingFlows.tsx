      ...
      <Container>
        <div className="text-center mb-20">
          ...
          <p className="mt-4 text-zinc-500 max-w-xl mx-auto text-sm leading-relaxed">
            From lease creation to executive insight. One platform. One source of truth.
          </p>
        </div>
          ...
          <div className="space-y-12">
            {FLOW_STEPS.map((item, i) => (
              ...
              >
                ...
                <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-amber-500/60 mb-1">
                  {item.step}
                </p>
                <h3 className="text-lg font-light text-white group-hover:text-amber-400/80 transition-colors duration-300">
                  {item.label}
                </h3>
                <p className="mt-1 text-sm text-zinc-500 font-light leading-relaxed max-w-md">
                  {item.detail}
                </p>
              </div>
            ))}
