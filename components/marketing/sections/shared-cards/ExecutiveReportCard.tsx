...
export function ExecutiveReportCard({ scale = 1 }: { scale?: number }) {
  return (
    <ProblemCard className="animate-float" style={{ width: 230, transform: `rotate(-2deg) scale(${scale})`, animationDelay: '1.2s' }}>
      <div className="flex items-center gap-2 mb-3"><FileText className="w-3.5 h-3.5 text-red-400/70" /><span className="text-[10px] text-zinc-400 font-light">Executive Report.pdf</span></div>
