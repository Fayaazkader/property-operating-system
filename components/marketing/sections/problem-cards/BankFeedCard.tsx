...
export function BankFeedCard() {
  return (
    <div className="absolute animate-float rounded-xl border border-white/[0.1] bg-white/[0.04] backdrop-blur-sm p-5 shadow-lg shadow-black/30" style={{ left: 165, top: 155, width: 220, transform: 'rotate(0deg)', animationDelay: '0.6s' }}>
      ...
      <div className="mt-2 pt-2 border-t border-white/[0.06] flex justify-between text-[10px]">
        ...
        <span className="text-emerald-400/70">2</span>
        <span className="text-zinc-500 ml-3">Unmatched</span>
