...
export type PeriodStatus =
  "open" | "ready_to_close" | "pending_review" | "closed";
...
export type DepositStatus =
  "requested" | "held" | "partially_applied" | "refunded" | "closed";
...
export interface PostingTemplateLine {
  ...
  account_resolver: string;
  amount_formula: string;
  vat_treatment: VatCategory;
  vat_account_resolver?: string;
...
export interface BankTransaction {
  ...
  statement_running_balance?: number;
