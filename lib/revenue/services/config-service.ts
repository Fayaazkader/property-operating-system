...
// Invoice configs, statement configs, tenant overrides all live here.
...
export const configService = {
  async getInvoiceConfig(entityId: string): Promise<InvoiceConfig> {
  ...
  async getStatementConfig(entityId: string): Promise<StatementConfig> {
