      ...
      leases?.forEach((lease) => {
        ...
        if (diffDays <= 30) {
          ...
          generatedNotifications.push({
            ...
            detail:
              "Immediate renewal engagement recommended to mitigate operational vacancy exposure.",
          });
          ...
          generatedNotifications.push({
            ...
            detail:
              "Tenant retention strategy should be initiated proactively.",
          });
        }
        ...
        if (
          ...
          generatedNotifications.push({
            ...
            detail:
              "Asset performance deterioration detected. Escalated monitoring recommended.",
          });
        }
      ...
      tasks?.forEach((task) => {
        ...
        if (
          ...
          generatedNotifications.push({
            ...
            detail:
              "Operational workflow remains incomplete and requires action.",
          });
        }
    ...
    <PageShell>
      ...
      <Toolbar>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <ToolbarButton label="Filter Alerts" />

          <ToolbarButton label="Export Notifications" />
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div>
            ...
            <p className="text-zinc-500 mt-2">
              Operational events requiring review or action.
            </p>
        ...
        {selectedNotification && (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="rounded-2xl border border-zinc-200 px-5 py-3 text-sm font-semibold text-black">
