        ...
        <Container>
          <div className="text-center mb-20">
            ...
            <p className="mt-6 text-zinc-400 max-w-lg mx-auto text-sm leading-relaxed">
              AssetFlow was designed by professionals who have worked in administration, leasing,
              property management, and portfolio management. Not software people trying to understand
              property — property people building the software they wish had existed.
            </p>
          </div>
        </Container>
      </Section>
