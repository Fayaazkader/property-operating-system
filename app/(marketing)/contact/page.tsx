        ...
        <Container>
          <div className="max-w-lg mx-auto text-center">
            ...
            <p className="mt-4 text-zinc-400 text-sm leading-relaxed">
              See how AssetFlow connects your entire commercial property portfolio into one intelligent operating system.
            </p>

            {submitted ? (
              <div className="mt-10 rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.03] p-8 text-center">
                <p className="text-sm font-medium text-white">Thank you — your enquiry has been submitted.</p>
                <p className="mt-2 text-xs text-zinc-400">Our team will contact you within one business day.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="mt-10 space-y-4 text-left">
                ...
                <select className="w-full rounded-xl border border-white/[0.08] bg-white/[0.02] px-4 py-3 text-sm text-white outline-none focus:border-white/20 transition-all">
                  <option value="">Portfolio size</option>
                  <option>1–25 properties</option>
                  <option>26–100 properties</option>
                  <option>101–250 properties</option>
                  <option>251–500 properties</option>
                ...
                <button type="submit" className="w-full rounded-full border border-amber-500/50 px-8 py-4 text-sm font-medium text-white hover:bg-amber-500 hover:text-black transition-all duration-300">
                  Submit Enquiry
                </button>
              </form>
            )}
            ...
            <p className="mt-6 text-xs text-zinc-600">
              Or email us at{' '}
              <Link href="mailto:hello@assetflow.africa" className="text-zinc-400 hover:text-white transition-colors">hello@assetflow.africa</Link>
            </p>
          </div>
        </Container>
      </Section>
