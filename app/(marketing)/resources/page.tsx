      ...
      <Section id="resources" className="pt-32 md:pt-48 pb-20">
        <Container>
          ...
          <div className="grid gap-6 md:grid-cols-3 max-w-3xl mx-auto">
            {[
              { title: 'Blog', desc: 'Insights on commercial property management, finance, and operations.' },
              { title: 'Guides', desc: 'In-depth guides on billing, recoveries, and financial close.' },
              { title: 'Webinars', desc: 'Live and recorded sessions with property industry experts.' },
            ].map((item) => (
              <div key={item.title} className="rounded-2xl border border-white/[0.05] bg-white/[0.01] p-6 text-center">
