// app/api/brokerage/commissions/[id]/approve/route.ts
// Approve Commission API
...
export async function POST(
  ...
  try {
    ...
    const result = await brokerageOrchestrator.approveCommission(id, platformContext.userId, platformContext.correlationId);
