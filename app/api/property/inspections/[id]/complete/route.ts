// app/api/property/inspections/[id]/complete/route.ts
...
export async function POST(req: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const result = await propertyOrchestrator.completeInspection(id, body.findings, body.severity, body.report_url);
    if (result.error) {
