        ...
        {outlook ? (
          <>
            ...
            {outlook.top_priorities?.[0] && (
              <div className="rounded-xl border border-amber-500/10 bg-amber-500/[0.02] p-4 mt-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-0.5">R{outlook.top_priorities[0].amount?.toLocaleString()} at risk</p>
                  </div>
                  <Link href="/tenants" className="rounded-full bg-white px-4 py-1.5 text-xs font-medium text-black hover:bg-gray-100">Review</Link>
                </div>
              </div>
            )}
          </>
