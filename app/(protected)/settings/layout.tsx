...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: '/financial/invoice-config', label: 'Invoice { key: '/financial/invoice-config', label: 'Invoice & Statement Config' },
      { key: '/financial/billing-policies', label: 'Billing Policies' },
      { key: '/financial/payment-terms', label: 'Payment Terms' }, Statement Config' },
      { key: '/financial/billing-policies', label: 'Billing Policies' },
