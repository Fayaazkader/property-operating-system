  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-6 pt-8 pb-12">
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        <Link href={`/leases/${lease?.lease_id}/edit`} className="flex items-center gap-1.5 rounded-full border border-[var(--border-default)] px-3 py-1.5 text-xs text-[var(--text-secondary)] hover:border-[var(--border-hover)] hover:text-[var(--text-primary)] transition-colors"><Pencil className="w-3 h-3" /> Edit Lease</Link>
