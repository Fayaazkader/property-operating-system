...
export default function CustomDropdown({
  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`}>
      ...
      {isOpen && !disabled && (
        <div className="absolute z-50 w-full mt-1 rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] shadow-lg overflow-hidden max-h-60 overflow-y-auto">
          {options.length === 0 ? (
